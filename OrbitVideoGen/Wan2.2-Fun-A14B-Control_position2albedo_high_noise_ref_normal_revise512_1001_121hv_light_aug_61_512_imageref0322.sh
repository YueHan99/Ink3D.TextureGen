...
# boundary corresponds to timesteps [900, 1000]
  ...
  # --lora_checkpoint "./models/train/Wan2.2-Fun-A14B-Control_high_noise_lora_ref_position_normal_drop_revise512_1001_121hv_light_aug_61_512_imageref0316/step-1950.safetensors" \
