    ...
    def __getitem__(self, data_id):
        ...
        while retry_count < max_retry:
            try:
                ...
                tmp_path = os.path.dirname(path).replace('objaverse_60k_120h000/videos_curve/','objavers_ref_random2/')
                ...
                if not os.path.exists(ref_path0):
                    ...
                    # import pdb;pdb.set_trace()
                    tmp_path = os.path.dirname(path).replace('objaverse_60k_120h000/','objaverse_60k_1001_customh_3pointlight/')
                    # tmp_path = tmp_path.replace('objaverse_60k_1001_customh/','objaverse_60k_1001_customh_3pointlight/')
                    ...
                    # tmp_path = os.path.dirname(path).replace('objaverse_60k_1001_customh/','objaverse_60k_1001_customv/')
                ...
                # print(W, H)                concatenated_image.paste(reference_image, (0, 0))      # 左边
