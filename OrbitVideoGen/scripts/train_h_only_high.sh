#!/bin/bash
# Mode 1: H-only training (HIGH noise, 512x512, 121 frames)
...
accelerate launch examples/wanvideo/model_training/train_14b_ref_normal_revise_light_aug_61_revise2_121h0322_v2.py \
  ...
  --dataset_repeat 1 \
  --model_paths '["/mnt/v-hanyue/20260610/local_models/local_models/PAI/Wan2.2-Fun-A14B-Control/Wan2.2-Fun-A14B-Control/high_noise_model/diffusion_pytorch_model.safetensors", "/mnt/v-hanyue/20260610/local_models/local_models/Wan-AI/Wan2.1-T2V-1.3B/Wan2.1-T2V-1.3B/models_t5_umt5-xxl-enc-bf16.pth", "/mnt/v-hanyue/20260610/local_models/local_models/Wan-AI/Wan2.1-T2V-1.3B/Wan2.1-T2V-1.3B/Wan2.1_VAE.pth"]' \
  --learning_rate 1e-4 --num_epochs 5 --save_steps 50 \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/h_only_high" \
